...
class KeyboardListenerService : ListenerService(), NativeKeyListener {
    ...
    private fun toFinalKeyCode(event: NativeKeyEvent): Int {
        ...
        // Action keys
            ...
            NativeKeyEvent.VC_PRINTSCREEN -> if (event.rawCode == 44) KeyEvent.VK_PRINTSCREEN else KeyEvent.VK_MULTIPLY
            ...
            NativeKeyEvent.VC_META -> KeyEvent.VK_WINDOWS
        ...
        // Character keys
            NativeKeyEvent.VC_EQUALS -> KeyEvent.VK_ADD
            NativeKeyEvent.VC_SLASH -> KeyEvent.VK_QUOTE
            NativeKeyEvent.VC_BACKQUOTE -> event.rawCode
